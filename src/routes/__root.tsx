...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A premium learning platform for structured, world-class remote training programs." },
      { property: "og:title", content: "LMS Trainee Program — Premium Remote Training" },
      { property: "og:description", content: "A premium learning platform for structured, world-class remote training programs." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "LMS Trainee Program — Premium Remote Training" },
      { name: "twitter:description", content: "A premium learning platform for structured, world-class remote training programs." },
